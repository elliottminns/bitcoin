...
Source100:	https://upload.wikimedia.org/wikipedia/commons/4/46/Livecoin.svg
...
%description
Livecoin is a digital cryptographic currency that uses peer-to-peer technology to
...
to run a Livecoin wallet, this is probably the package you want.
%endif


%package libs
Summary:	Livecoin shared libraries
...
Encoding=UTF-8
Name=Livecoin
Comment=Livecoin P2P Cryptocurrency
Comment[fr]=Livecoin, monnaie virtuelle cryptographique pair à pair
Comment[tr]=Livecoin, eşten eşe kriptografik sanal para birimi
Exec=bitcoin-qt %u
Terminal=false
Type=Application
Icon=bitcoin128
...
getent passwd bitcoin >/dev/null ||
	...
	-c "Livecoin wallet server" bitcoin
exit 0
