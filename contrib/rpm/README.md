...
The RPM spec file provided here is for Livecoin-Core 0.12.0 and builds on CentOS
...
[Livecoin git repository](https://github.com/bitcoin/bitcoin) but are not part of
...
in the bitcoin git repository. At present only an SVG version of the Livecoin
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the Livecoin git
master branch.
...
idea to build Livecoin Core against a static version of that library compiled
...
Livecoin-Core against OpenSSL or use a patched version of Boost in the build
system.
...
packaging Livecoin for Fedora at least since 2012.
