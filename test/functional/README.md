...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the LivecoinTestFramwork, place overrides for the
...
the Livecoin Core node application logic. For custom behaviour, subclass the
...
maintain using the standard LivecoinTestFramework.
