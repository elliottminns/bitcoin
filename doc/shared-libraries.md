...
The purpose of this library is to make the verification functionality that is critical to Livecoin's consensus available to other applications, e.g. to language bindings.
...
- [NLivecoin](https://github.com/NicolasDorier/NLivecoin/blob/master/NLivecoin/Script.cs#L814) (.NET Bindings)
