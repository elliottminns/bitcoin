Livecoin Core version 0.14.0 is now available from:
...
Livecoin Core is extensively tested on multiple operating systems using
...
Livecoin Core should also work on most other Unix-like systems but is not
...
Livecoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
When Livecoin Core is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in Livecoin Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Livecoin Core. This was added in conjunction with
