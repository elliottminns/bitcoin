Livecoin v0.3.24 is now available for download at
https://sourceforge.net/projects/bitcoin/files/Livecoin/bitcoin-0.3.24/
...
C3) Initial unit testing framework.  Livecoin sorely needs automated tests, and this is a beginning.  Contributions welcome.
