Livecoin version 0.5.0 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Livecoin/bitcoin-0.5.0/
...
If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or bitcoind the wallet will be rewritten, Livecoin will
...
Livecoin-Qt: Address Book, then New Address...
