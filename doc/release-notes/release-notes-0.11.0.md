Livecoin Core version 0.11.0 is now available from:
...
Block pruning allows Livecoin Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Livecoin Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only LivecoinAmountField
...
- #6116 `30dc3c1` [OSX] rename Livecoin-Qt.app to Livecoin-Core.app
