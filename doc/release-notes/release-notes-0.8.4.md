Livecoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Livecoin/bitcoin-0.8.4/
...
code, causing the Livecoin-Qt or bitcoind process to crash.
...
their own version of Livecoin against Boost versions 1.50-1.52.
