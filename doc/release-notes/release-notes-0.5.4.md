Livecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Livecoin/bitcoin-0.5.4/
...
Fix Livecoin-Qt notifications under Growl 1.3.
Increase required age of Livecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLivecoin properly when installing Livecoin-Qt over it. (Windows)
