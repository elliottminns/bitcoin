...
### Livecoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Livecoin Core for Linux, Windows, and OS X:
...
- Update bitcoin.org version
  ...
  - First, check to see if the Livecoin.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the Livecoin.org release
...
- Announce the release:
  ...
  - Livecoin Core announcements list https://bitcoincore.org/en/list/announcements/join/

  - bitcoincore.org blog post

  - Update title of #bitcoin on Freenode IRC

  - Optionally twitter, reddit /r/Livecoin, ... but this will usually sort out itself
